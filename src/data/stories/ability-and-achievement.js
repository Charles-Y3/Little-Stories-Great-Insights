export default {
  id: "ability-and-achievement",
  order: 29,
  title: { zh: "能力與成就", en: "Ability and Achievement" },
...
Faced with the same tasks, one measures the self first; the other opens to learning and ownership. Achievement tends to follow the second.`
  ...
  prompts: {
    ...
    en: [
      "Are you more like A, or more like B?",
      "When is \"don't be greedy\" humility — and when is it holding back?",
      "What responsibility have you been avoiding that you could take on?"
    ]
  },

  image: "ability-and-achievement",
  speech: { zh: "" }
};
